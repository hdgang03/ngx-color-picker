...
import {CpPresetColors} from "./color-picker.directive";
...
export class ColorPickerComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    public setupDialog(instance: any, elementRef: ElementRef, color: any,
                       ...
                       cpPresetLabel: string, cpPresetColors: string[], cpPresetColorsArr: CpPresetColors[], cpPresetColorsClass: string,
        ...
        this.cpPresetColorsArr = cpPresetColorsArr;
        this.setPresetConfig(cpPresetLabel, cpPresetColors, this.cpPresetColorsArr,);
