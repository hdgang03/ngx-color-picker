import {
    ...
    Injector, ComponentFactoryResolver, EmbeddedViewRef, TemplateRef
} from '@angular/core';
...
export class ColorPickerDirective implements OnChanges, OnDestroy {
    ...
    @Input() cpPresetColorsArr: CpPresetColors[];
    ...
    public openDialog(): void {
        if (!this.dialogCreated) {
            ...
            this.cmpRef.instance.setupDialog(this, this.elRef, this.colorPicker,
                ...
                this.cpPositionRelativeToArrow, this.cpPresetLabel, this.cpPresetColors, this.cpPresetColorsArr,
